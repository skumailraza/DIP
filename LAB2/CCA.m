% KUMAIL RAZA
% BESE 5
% Connected Components Labelling Implementation Matlab

img = imread('lab2_task2_1.jpg');
...
% Answer to question:
% bwlabel is the labelling command in MATLAB and labelmatrix is the output
% matrix of the same size as the image with labes in it.